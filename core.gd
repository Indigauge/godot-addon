...
# Mirrors runtime validation rules: only letters and exactly one '.' not first/last. 12
...
# Hardware bucketing helpers inspired by indigauge-core/hardware.rs. 13
